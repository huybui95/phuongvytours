                                ...
                                <tr class="row-has-options"
                                    ...
                                    <td
                                        ...
                                        <div class="row-options">
                                            ...
                                            <?php } ?>
                                            <?php if (staff_can('delete', 'items')) { ?>
                                            | <a href="<?= admin_url('invoice_supplier_items/delete_group/' . $group['id']); ?>"
...
<script>
    $(function() {
        ...
        initDataTable('.table-invoice-items', admin_url + 'invoice_supplier_items/table',
        ...
        $('#new-item-group-insert').on('click', function() {
            ...
            if (group_name != '') {
                $.post(admin_url + 'invoice_supplier_items/add_group', {
                    name: group_name
                }).done(function() {
                    window.location.href = admin_url + 'invoice_supplier_items?groups_modal=true';
                });
            }
        });
        ...
        $('body').on('click', '.update-item-group', function() {
            ...
            if (name != '') {
                $.post(admin_url + 'invoice_supplier_items/update_group/' + group_id, {
                    name: name
                }).done(function() {
    ...
    function items_bulk_action(event) {
        if (confirm_delete()) {
            ...
            setTimeout(function() {
                $.post(admin_url + 'invoice_supplier_items/bulk_action', data).done(function() {
